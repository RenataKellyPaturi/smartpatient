			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<a class="btn btn-success pull-right" href="administradores.jsp"><i class="fa fa-arrow-left"></i> Voltar</a>
					...
					<div class="panel panel-primary">
					  ...
					  <div class="panel-heading">Inserindo Administradores</div>
						  <div class="panel-body">
							   <form class="form-horizontal" href="../administradorServ" method="get" id="inserirAdministrador">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
								      <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o nome do administrador">
								    </div>
								</div>
								<div class="form-group">
									<label for="senha" class="col-sm-2 control-label">Senha</label> 
									<div class="col-sm-10">
								      <input type="password" class="form-control" id="senha" name="senha" placeholder="Digite a senha do administrador">
								    </div>
								</div>
