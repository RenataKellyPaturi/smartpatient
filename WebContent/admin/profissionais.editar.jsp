...
<%@ page import="br.com.fafica.smartpacient.control.ProfissionalService" %>
<%@ page import="br.com.fafica.smartpacient.entity.impl.Profissional" %>

<%
if(session.getAttribute("adm") == null){
    response.sendRedirect("login.jsp");
}  
	ProfissionalService profControl = new ProfissionalService();

	int id = Integer.parseInt(request.getParameter("id"));
	Profissional profissional = profControl.listForId(request.getParameter("id"));
%>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">Editar profissional <%=profissional.getNome() %></div>
					<div class="panel-body">
						<div class="container-fluid">
						 ...
						 <form id="concluindoEditarForm" action="return false;" class="formcadastro">
							...
							<input type="hidden" name="action" value="editarProfissional">
