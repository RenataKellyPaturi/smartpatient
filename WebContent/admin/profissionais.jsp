...
<body class="interno">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<a class="btn btn-success pull-right" href="profissionais.cadastro.jsp"><i class="fa fa-plus"></i> Inserir Novo Profissional</a>
				
				<div class="panel panel-primary">
				  <!-- Default panel contents -->
				  <div class="panel-heading">Profissionais Assinantes do Sistema</div>
				  <div class="panel-body">
				    <p>Lista de todos os profissionais cadastrados no sistema</p>
				 
				
				  <!-- Table -->
				  <table class="table table-striped listaProf">
						<thead>
							<tr>
	...
	<script type="text/javascript" src="../assets/libs/datatable/media/js/jquery.dataTables.js"></script>
