		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading">Inserindo Alimentação</div>
					<div class="panel-body">
						<form class="form-horizontal" href="../alimentacaoServ" method="post" id="inserirAlimentacao">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea class="form-control" id="descricao"
										name="descricao" rows="" cols=""></textarea>
								</div>
							</div>
