...
<title>Enviar dica SmartPacient</title>
<meta
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading">Enviando Dica</div>
					<div class="panel-body">
						<form class="form-horizontal" href="../dicaServ" method="get" id="inserirDica">
								...
								<div class="col-sm-5">
									<div class="btn-group" data-toggle="buttons">
									  <label class="btn btn-info">
									    <input type="radio" name="importancia" id="option1" autocomplete="off" value="baixa" checked> BAIXA
									  </label>
							...
							<div class="form-group">
								<label for="dica" class="col-sm-2 control-label">Título da Dica</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="titulo" name="titulo"
										placeholder="Digite o título da dica" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea class="form-control" id="descricao" name="descricao"
										rows="" cols=""placeholder="Digite a descrição aqui..." required></textarea>
								</div>
							</div>
