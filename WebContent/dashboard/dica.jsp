...
<a class="btn btn-success pull-right" href="cadastro-dica.jsp"><i class="fa fa-plus"></i> Inserir Dica</a>
			 
				<div class="panel panel-primary">
				  <!-- Default panel contents -->
				  <div class="panel-heading">Lista de Dicas</div>
				  <div class="panel-body">
					  ...
					  <!-- Table -->
						...
						<table class="table table-striped listaDica">
							<thead>
								<tr>
									<th class="col-md-1">#</th>
									
									<th>Título da dica</th>
