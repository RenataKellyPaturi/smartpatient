...
<title>Alimentacao SmartPacient</title>
<meta
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<a class="btn btn-success pull-right" href="alimentacao.jsp"><i
					class="fa fa-arrow-left"></i> Voltar</a>
				<div class="panel panel-primary">
					<!-- Default panel contents -->
					<div class="panel-heading">Alterar Alimentação</div>
					<div class="panel-body">
						<form class="form-horizontal" href="../alimentacaoServ"
							method="post" id="editarAlimentacao">

							<div class="form-group">
								<label for="nome" class="col-sm-2 control-label">Nome</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nome" name="nome"
										placeholder="Digite o nome do Alimento" value="">
								</div>
							</div>
