...
<%	int id = Integer.parseInt(request.getParameter("id"));
	...
	FichaAcompanhamentoService control = new FichaAcompanhamentoService();
	FichaAcompanhamento f = control.listForId(String.valueOf(id));
%>
...
<title>Editar Ficha Acompanhamento- SmartPacient</title>
							 ...
							 <form id="editarFicha"
									action="../fichaAcompanhamento" method="POST"  accept-charset="UTF-8">
										...
										<div class="form-group">
											...
											<textarea class="form-control" name="observacaoficha"><%= f.getObservacao() %></textarea>
											 
										</div>
										<%
										 
										 String[] datamontada = f.getData().toString().split("-");
										 
										 %>
										<div class="form-group">
											<label>Data do  Acompanhamento</label> <input type="text" class="form-control data"
