...
<title>Mensagens  -  SmartPacient</title>
<meta
...
<a class="btn btn-success pull-right" href="mensagem-cadastro.jsp"><i class="fa fa-plus"></i> Enviar Mensagem</a>
				...
				<div class="panel panel-primary">
				  ...
				  <div class="panel-body">
					  ...
					  <!-- Table -->
						...
						MensagemService me = new MensagemService();
						List<Mensagem> mensagens = me.listAllFromPacienteActive(Long.parseLong(request.getSession().getAttribute("pacienteId").toString()));
						...
						if (mensagens != null ) {
							...
							%>
								<tr>
									<td><%=m.getId() %></td>	
									<td><%=m.getAssunto() %></td>
									<td><%=m.getPaciente().getNome() %></td>
									<td>
										<a href="mensagem-editar.jsp?id=<%=m.getId() %>" class="btn btn-success "> 
											<i class="fa fa-edit"></i> 
										</a>
										
										<a href="../mensagemServlet?action=inativar&id=<%=m.getId() %>" onclick="return confirm('Deseja realmente excluir?')" class="btn btn-danger "> 
