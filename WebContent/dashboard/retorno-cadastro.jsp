				...
				<div class="panel panel-primary">
				 ...
				 <form class="form-horizontal" action="../RetornoServlet" method="post" id="inserirMensagem">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
					      <input type="text" class="form-control data" id="data" name="data" placeholder="Escolha a data de retorno">
					    </div>
					</div>
					<div class="form-group">
						<label for="mensagem" class="col-sm-2 control-label">Horário</label> 
						<div class="col-sm-10">
					      <input type="text" class="form-control " name="horario" id="horario" placeholder="Digite o horário no formato: hh:mm">
					    </div>
					</div>
